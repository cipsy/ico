...
with open ('icobench_data.csv','w') as outfile:
   ...
   csv_writer.writerow (["title","subtitle","desc","categs","profile", "team", "vision", "product","Token","PreICO_Price","Price","Price_in_ICO","Platform","Accepting","Minimum_investment","Soft_cap","Hard_cap","Country","Whitelist_KYC","Restricted_areas","preICO_start","preICO_end","ICO_start","ICO_end","Raised","Status","Time"])
